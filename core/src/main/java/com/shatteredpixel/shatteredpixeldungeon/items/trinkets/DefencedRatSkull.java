...
public class DefencedRatSkull extends Trinket {

	{
		image = ItemSpriteSheet.DEFENCED_RAT_SKULL;
	}
	...
	public static float exoticChanceMultiplier(){
		return exoticChanceMultiplier(trinketLevel(DefencedRatSkull.class));
	}
